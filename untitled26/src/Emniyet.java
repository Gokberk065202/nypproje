...
public class Emniyet {
    ...
    public static void main(String[] args) {
        ...
        boolean x=false,z=true,l=true,m=true;  //döngü içinde kullandıklarım
        String kullaniciadi,kullanicisifre;  //polis girisi icin
        String sifreemniyet;       //emniyet mudur girisi

        int y;     //secim yapmak icin
